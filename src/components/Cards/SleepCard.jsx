...
const SleepCard = ({ title, time ,icon,iconcolor,iconbg,value,status,seticoncolor}) => {
    return(
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: "center" }}>
            <Text style={{ fontSize: 20, fontWeight: '600',color:GlobalColor.textColor }}>{title}</Text>
        ...
        <View style={{ flexDirection: 'row', width: 'auto', alignItems: 'center', gap: 5 }}>
            <Text style={{ fontSize: 38, fontWeight: '600',color:GlobalColor.textColor }}>{value}</Text>
            <View>
                <Text style={{ fontWeight: '600',color:'#D9D9D9',color:GlobalColor.textColor }}>AM</Text>
                <Text style={{ fontWeight: '600',color:GlobalColor.textColor }}>PM</Text>
            </View>
        </View>
        <Pressable style={{flexDirection:'row',  alignItems: 'center',justifyContent:'space-between', marginTop: 10 }}>
            <Text style={{ color: '#666D80', fontWeight: '600',color:GlobalColor.textColor }}>Tap to set alarm</Text>
